...
const Result: React.FC = () => {
    ...
    const { answers, questionData } = state as LocationState;
    ...
    return (
        ...
        <>
            <div className="shadow m-md-5 m-sm-3 m-0 rounded-5 p-1 p-md-5 p-sm-3">
                ...
                <p  className="text-center fs-4" style={{ color: "#22CA39" }}>{scorePercentage}%</p>
                ...
                {questions
                    ...
                    return (
                        ...
                        >
                        <p className="text-black-50">Question {index + 1}</p>
