...
const HomeUi: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="d-flex flex-column align-items-center justify-content-center text-center py-4 mb-5" style={{ backgroundColor: "#EEF5FB" }}>
                ...
                <div className="row w-100 justify-content-center gap-3 my-3 px-3">
                    ...
                    <div className="col-12 col-sm-5 col-md-4 col-lg-3">
                    <button className="w-100 border-0 px-4 py-2 rounded-2 text-white" style={{ backgroundColor: "#041826b9" }} onClick={() => navigation("/blog")}>
                        Study tips & guide
                    </button>
                    </div>
                </div>
            ...
            <div className="container my-5">
                <div className="row g-4 justify-content-center">
                    ...
                    >
                        <div
                        className="flex-fill text-center p-4 rounded-4 shadow-sm border h-100 d-flex flex-column align-items-center justify-content-start gap-3 bg-white card-hover"
